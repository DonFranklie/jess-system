...
export default function Home() {
  ...
  return (
    ...
    <div className="m-4 p-8">
      ...
      <h1 className="mb-8 text-2xl sm:text-xl font-semibold text-slate-600">
        Welcome to JIESS, {user?.firstName} 
          ...
          <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <a href="/past-papers" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Access Past Papers
